...
const getVisitorWeather = async (lat, lon) => {
  ...
  apiObject = {
    clicked: false,
    visible: false,
    temp: api.data.current_condition[0].temp_C + "°C",
    pressure: api.data.current_condition[0].pressure,
    humidity: api.data.current_condition[0].humidity,
    windSpeed: api.data.current_condition[0].windspeedKmph,
    uvIndex: api.data.current_condition[0].uvIndex,
    weatherDescription: api.data.current_condition[0].weatherDesc[0].value,
